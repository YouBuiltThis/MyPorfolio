  ...
  $(document).ready(function () {
    ...
    function s() {
      $(".slider--prev, .slider--next").click(function () {
        ...
        setTimeout(function () {
          let direction = currentButton.hasClass("slider--next") ? 1 : -1; // 1 => right, -1 => left
          ...
          let allProjects = $(
            ".l-section.section .work .work--lockup .slider .slider--item"
          );
          let numProjects = allProjects.length;

          console.log("There are ", numProjects, " projects!");
          ...
          for (let i = 0; i < numProjects; ++i) {
            ...
            if (allProjects.eq(i).hasClass("slider--item-center")) {
              ...
              console.log(oldLeftId, oldCenterId, oldRightId);
              ...
              console.log(newCenterId, " / dir = ", direction);
              if (newCenterId == -1) {
                newCenterId = numProjects - 1;
              } else if (newCenterId == numProjects) {
                newCenterId = 0;
              }
              ...
              if (newLeftId == -1) {
                newLeftId = numProjects - 1;
              } else if (newLeftId == numProjects) {
                newLeftId = 0;
              }
              ...
              if (newRightId == -1) {
                newRightId = numProjects - 1;
              } else if (newRightId == numProjects) {
                newRightId = 0;
              }

              console.log(newLeftId, newCenterId, newRightId);

              // Add new center, left, right
              allProjects
                .eq(newCenterId)
                .removeClass("slider--item-hidden")
